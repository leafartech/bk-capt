      ...
      <header className="header relative min-h-screen sm:flex sm:justify-center border-b-2 border-my2">
        ...
        <div className="absolute sm:w-full sm:max-w-7xl h-full flex items-center justify-start px-4 z-20">
          ...
          <div className="flex flex-col items-start justify-start sm:max-w-lg">
            ...
            <h1 className="text-my2  font-bold text-2xl sm:text-4xl my-3">Sua Fonte de Produtos Elétricos com Entrega Imediata em Todo o Brasil!</h1>
            <p className="text-zinc-600 text-base mb-3">Cadastre-se abaixo para entrar na nossa lista vip e receber ofertas especiais de produtos a pronta entrega no whatsapp</p>
